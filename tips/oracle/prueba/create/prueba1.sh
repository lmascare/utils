...
CREATE TABLESPACE TOOLS DATAFILE '/oradata/data/prueba/tools01.dbf' SIZE 10M 
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M ;
ALTER DATABASE DATAFILE '/oradata/data/prueba/tools01.dbf' AUTOEXTEND OFF;

REM ********** TABLESPACE FOR ROLLBACK **********
CREATE TABLESPACE RBS DATAFILE '/oradata/data/prueba/rbs01.dbf' SIZE 100M 
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 2M ;
ALTER DATABASE DATAFILE '/oradata/data/prueba/rbs01.dbf' AUTOEXTEND OFF;

REM ********** TABLESPACE FOR TEMPORARY **********
CREATE TEMPORARY TABLESPACE TEMP TEMPFILE '/oradata/data/prueba/temp01.dbf' SIZE 100M 
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M ;
ALTER DATABASE TEMPFILE '/oradata/data/prueba/temp01.dbf' AUTOEXTEND OFF;

REM ********** TABLESPACE FOR USER **********
CREATE TABLESPACE USERS DATAFILE '/oradata/data/prueba/users01.dbf' SIZE 10M 
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M ;
ALTER DATABASE DATAFILE '/oradata/data/prueba/users01.dbf' AUTOEXTEND OFF;
