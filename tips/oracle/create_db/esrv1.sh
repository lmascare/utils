...
svrmgrl << EOF
spool /u2/admins/oracle/admin/esrv/create/crdb2.log
connect internal
...
CREATE TABLESPACE TOOLS DATAFILE '/u5/oracle/data/esrv/tools01.dbf' SIZE 10M 
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M ;
ALTER DATABASE DATAFILE '/u5/oracle/data/esrv/tools01.dbf' AUTOEXTEND OFF;

REM ********** TABLESPACE FOR ROLLBACK **********
CREATE TABLESPACE RBS DATAFILE '/u5/oracle/data/esrv/rbs01.dbf' SIZE 400M 
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 2M ;
ALTER DATABASE DATAFILE '/u5/oracle/data/esrv/rbs01.dbf' AUTOEXTEND OFF;

REM ********** TABLESPACE FOR TEMPORARY **********
CREATE TEMPORARY TABLESPACE TEMP TEMPFILE '/u5/oracle/data/esrv/temp01.dbf' SIZE 400M 
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M ;
ALTER DATABASE TEMPFILE '/u5/oracle/data/esrv/temp01.dbf' AUTOEXTEND OFF;

REM ********** TABLESPACE FOR USER **********
CREATE TABLESPACE USERS DATAFILE '/u5/oracle/data/esrv/users01.dbf' SIZE 10M 
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M ;
ALTER DATABASE DATAFILE '/u5/oracle/data/esrv/users01.dbf' AUTOEXTEND OFF;
